...
public class AI {
	...
	public boolean isLegal(Move m) {
		...
		myBoard.performMove(m, true);
		
		if(myBoard.isKingThreatened()) { //this is a legal move
			result = false;
		}
		
		//undo the test move
		myBoard.undoMove(myBoard.moveStack.pop(), true); 
